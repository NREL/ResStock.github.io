...
<details>
    ...
    See this explanation which has more details and also points to other ResStock references about how to increase the number of samples and calculate the uncertainty.
    </p>
</details>
...
<details>
    ...
    The Data Viewer can show timeseries data or data aggregations in a web browser. More information can be found in the Web-Based Visualization Platform of the <a href="https://nrel.github.io/ResStock.github.io/assets/trd/ResStockTechnicalReferenceGuide_2025_1.pdf">ResStock technical reference documentation</a>.
...
<details>
    ...
    See the <a href="https://nrel.github.io/ResStock.github.io/assets/trd/ResStockTechnicalReferenceGuide_2025_1.pdf">ResStock technical reference documentation</a> for more information on how utility bills are calculated for the most recent release. Utility bill calculation methods may differ between releases. </p>
</details>
