...
- [Download Timeseries Baseline and Upgrade Data]({{  site.baseurl  }}{% link docs/resources/how-to-guides/access_timeseries_data_programmatically.ipynb %}) Example Jupyter notebook for pulling timeseries aggregate files from the OEDI data lake for a certain geography and housing type, and then plots a comparison.