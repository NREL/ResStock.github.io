...
Access the webinar recording, webinar slides, and the technical documentation for each dataset as they are available:
 - 2024.2 [webinar recording](https://youtube/tk1Uoq5_a38?si=gjhOnzb4-AcbdwZt), [webinar slides](https://www.nrel.gov/docs/fy24osti/89600.pdf), and the [technical reference documentation](https://docs.nrel.gov/docs/fy25osti/91621.pdf)
